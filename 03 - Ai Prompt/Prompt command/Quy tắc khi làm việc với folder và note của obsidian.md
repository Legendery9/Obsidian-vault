...
- **Định dạng Visual:** Phân tách heading bằng `---`. Sử dụng callouts thích hợp (`[!abstract]`, `[!info]`, `[!warning]`, `[!note]`), tìm hiểu thêm tại [[Obsidian format]]. Ví dụ code dùng block `java` và trình bày đối lập Do/Don't.